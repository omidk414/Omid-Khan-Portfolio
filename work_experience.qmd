...
- **Data Analyst (Center for Student Research)**
  ...
  - Research Mentors: Dr. Mokhtar Sadok, Dr. Lynne Grewe

 - Project Title: “**NeuroScan**”: Machine Learning Application for Brain Tumor Detection (Python, TensorFlow, Keras, OpenCV, Jupyter Notebooks) || [GitHub Repository]https://github.com/omidk414/NeuroScan{target=_blank}
